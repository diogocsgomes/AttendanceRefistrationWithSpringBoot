 ...
 */
    ...
    public void onSearchEvent(ActionEvent actionEvent) {
        ...
        for(Event event : events) {
            if(event.getName().contains(searchField.getText())) {
                filteredEvents.add(event);
            }
        }

        ObservableList<Event> observableEvents = FXCollections.observableArrayList(filteredEvents);
        eventsTable.setItems(observableEvents);
    }
}
