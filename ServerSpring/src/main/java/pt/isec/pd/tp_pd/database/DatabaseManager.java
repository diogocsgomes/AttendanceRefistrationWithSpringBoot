...
public class DatabaseManager {
	...
	public static DatabaseManager getInstance(MainServer mainServer) throws SQLException {
	...
	private DatabaseManager(MainServer mainServer) throws SQLException {
	...
	public synchronized User insertUser(String email, String password, String user_type, int user_id) {
	...
	public synchronized boolean editUser(int user_id, String email, String password) {
	...
	public synchronized Event insertEvent(
	...
	public synchronized boolean doesCodeExist(String code) {
	...
	public synchronized boolean registerAttendence(String code, int userId) {
	...
	public synchronized ArrayList<Event> listAttendances(int userId) {
	...
	public synchronized ArrayList<User> listEventUsers(int eventId) {
		String sql = "SELECT " +
				"u.user_id, " +
				"u.email, " +
				"u.user_type " +
	...
	public synchronized ArrayList<Event> listUserEventsPartialData(int userId) {
	...
	public synchronized boolean deleteAttendence(int eventId, int userId) {
	...
	public synchronized int getUserIdFromEmail(String email) {
		int user_id = -1;
	...
	public synchronized boolean addAttendence(int event_id, String user_email) {
		int affected;
	...
	public synchronized boolean editEvent(Event event) {
	...
	public User getUser(int id) {
		String getUserSql = "SELECT * FROM users WHERE user_id = ?";
